...
import static com.pinganfang.imagelibrary.compressor.Preconditions.checkNotNull;

/**
 * Created by jiajiewang on 16/8/24.
 */
public class ImageCompressorTools {
    private ImageCompressorTools() {
    }
    ...
    public static class Luban {
        ...
        public Luban launch() {
            ...
            if (gear == Luban.FIRST_GEAR) {
                if (compressListener != null) compressListener.onSuccess(firstCompress(mFile));
            } else if (gear == Luban.THIRD_GEAR) {
                if (compressListener != null) compressListener.onSuccess(thirdCompress(mFile));
            }
            return this;
        }
